 ...
 * @param {string} userId - User ID for creating a unique path
 * @returns {Promise<string>} - The S3 URL of the uploaded file
 */
const uploadFileToS3 = async (fileBuffer, originalFilename, userId) => {
  try {
    ...
    const directory = `users/${userId}/profile`;
